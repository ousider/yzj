 ...
 */
public class CdRoleModel extends BaseModel implements Serializable {
	...
	// 所属模块
	private Set<CdModuleModel> cdModule = new HashSet<CdModuleModel>();
	...
	public Set<CdModuleModel> getCdModule() {
		return cdModule;
	}

	public void setCdModule(Set<CdModuleModel> cdModule) {
