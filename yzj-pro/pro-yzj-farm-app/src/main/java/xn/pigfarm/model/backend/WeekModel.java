 ...
 * @Description:系统生成
 * @author :系统生成
 * @date :2016-8-18 9:15:44
 *       表：CD_O_WEEK
 */
public class WeekModel  extends BaseDataModel implements Serializable{

    private static final long serialVersionUID = -4329674401817740196L;
	...
	public List<String> getPropertes() {
	    if (super.getPropertes() == null || super.getPropertes().isEmpty()) {
	        ...
	        setPropertes(D_Year);
	        setPropertes(D_Week);
	        setPropertes(D_StartDate);
	        setPropertes(D_EndDate);
	    }
