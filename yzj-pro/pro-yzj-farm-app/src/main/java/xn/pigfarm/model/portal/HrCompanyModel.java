...
public class HrCompanyModel extends BaseModel implements Serializable {
	...
	// 部门
	private List<HrDeptModel> hrDept = new ArrayList<HrDeptModel>();
	...
	public List<HrDeptModel> getHrDept() {
		return hrDept;
	}

	public void setHrDept(List<HrDeptModel> hrDept) {
		this.hrDept = hrDept;
	}
