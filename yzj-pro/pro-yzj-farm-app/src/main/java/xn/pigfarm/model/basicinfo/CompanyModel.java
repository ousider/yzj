 ...
 *       表：HR_M_COMPANY
 */
public class CompanyModel  extends BaseDataModel implements Serializable{
    
    /**
     * @Description: TODO(用一句话描述这个变量表示什么)
     */
    private static final long serialVersionUID = 6221164175752090562L;
    ...
    // 是否开启
    private static final String D_OpenOrClose="openOrClose";

    // 关闭日期
    private static final String D_CloseDate="closeDate";
     ...
     * @param OPEN_OR_CLOSE
     */
	public void setOpenOrClose(String value) {
        set(D_OpenOrClose,value);
    }
    ...
    public String getOpenOrClose() {
        return getString(D_OpenOrClose);
    }
   ...
   static{
        ...
        propertes.add("openOrClose");
        propertes.add("closeDate");
    }
