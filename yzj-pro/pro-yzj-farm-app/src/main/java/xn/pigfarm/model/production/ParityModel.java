 ...
 *       表：PP_L_BILL_PARITY
 */
public class ParityModel  extends BaseDataModel implements Serializable{

    private static final long serialVersionUID = 979278234948296364L;
    ...
    // 转入日期
    private static final String D_ParityDate="parityDate";

    // 胎次
    private static final String D_Parity="parity";

    // 转出记录ID
    private static final String D_ChangeParityId="changeParityId";
     ...
     * @param PARITY_DATE
     */
	public void setParityDate(Date value) {
        set(D_ParityDate,value);
    }
     ...
     * @return PARITY_DATE
     */
    public Date getParityDate() {
        return getDate(D_ParityDate);
    }
     ...
     * 设置转出记录ID
     * 
     * @param CHANGE_PARITY_ID
     */
	public void setChangeParityId(Long value) {
        set(D_ChangeParityId,value);
    }
	
	/**
     * 获取转出记录ID
     * 
     * @return CHANGE_PARITY_ID
     */
    public Long getChangeParityId() {
        return getLong(D_ChangeParityId);
    }
	...
	public List<String> getPropertes() {
	    if (super.getPropertes() == null || super.getPropertes().isEmpty()) {
	        ...
	        setPropertes(D_Sex);
	        setPropertes(D_ParityDate);
	        setPropertes(D_Parity);
	        setPropertes(D_ChangeParityId);
	    }
