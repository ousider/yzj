 ...
 * @Description:系统生成
 * @author :系统生成
 * @date :2016-8-18 9:50:08
 *       表：CD_O_HARDWARE
 */
public class HardwareModel  extends BaseDataModel implements Serializable{

    private static final long serialVersionUID = 4071122633378781839L;
