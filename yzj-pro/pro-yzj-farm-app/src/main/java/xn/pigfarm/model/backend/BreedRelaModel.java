 ...
 *       表：CD_L_BREED_RELA
 */
public class BreedRelaModel  extends BaseDataModel implements Serializable{

    private static final long serialVersionUID = -1443935433209497834L;
	...
	public List<String> getPropertes() {
	    if (super.getPropertes() == null || super.getPropertes().isEmpty()) {
	        ...
	        setPropertes(D_SowId);
	        setPropertes(D_StockBoarId);
	        setPropertes(D_BroodSowId);
	    }
