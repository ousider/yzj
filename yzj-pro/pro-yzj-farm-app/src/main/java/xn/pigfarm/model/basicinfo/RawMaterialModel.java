 ...
 *       表：CD_O_RAW_MATERIAL
 */
public class RawMaterialModel  extends BaseDataModel implements Serializable{

    private static final long serialVersionUID = 85050504533668673L;
    ...
    // 原料类型
    private static final String D_RawMaterialType="rawMaterialType";
     ...
     * 设置原料类型
     * 
     * @param RAW_MATERIAL_TYPE
     */
	public void setRawMaterialType(String value) {
        set(D_RawMaterialType,value);
    }
    ...
    public String getRawMaterialType() {
        return getString(D_RawMaterialType);
    }
	...
	public List<String> getPropertes() {
	    if (super.getPropertes() == null || super.getPropertes().isEmpty()) {
	        ...
	        setPropertes(D_RawMaterialType);
