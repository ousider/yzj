 ...
 */
public class DeptView extends BaseModel implements Serializable {
	...
	//部门
	private List<DeptView> hrPost = new ArrayList<DeptView>();
	...
	public List<DeptView> getHrPost() {
		return hrPost;
	}

	public void setHrPost(List<DeptView> hrPost) {
		this.hrPost = hrPost;
	}
