 ...
 *       表：HR_O_DEPT
 */
public class DeptModel  extends BaseDataModel implements Serializable{

    private static final long serialVersionUID = 3682611033395438276L;
	...
	public List<String> getPropertes() {
	    if (super.getPropertes() == null || super.getPropertes().isEmpty()) {
	        ...
	        setPropertes(D_SupDeptId);
	        setPropertes(D_BusinessCode);
	        setPropertes(D_DeptName);
	        setPropertes(D_DeptDesc);
	        setPropertes(D_GroupDept);
	    }
