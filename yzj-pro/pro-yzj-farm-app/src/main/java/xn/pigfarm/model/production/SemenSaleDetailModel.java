 ...
 *       表：PP_L_BILL_SEMEN_SALE_DETAIL 
 */
public class SemenSaleDetailModel  extends BaseDataModel implements Serializable{
    private static final long serialVersionUID = -8742884057352384242L;
    ...
    private static final String D_SemenSaleRowId="semenSaleRowId";
	 //PP_M_SPERM_INFO的ROW_ID 
    private static final String D_SpermId="spermId";
   ...
   /**
    * 设置PP_M_SPERM_INFO的ROW_ID
    * @param SPERM_ID
    */
	public void setSpermId(Long value) {
        set(D_SpermId,value);
    }
	
	/**
    * 获取PP_M_SPERM_INFO的ROW_ID
    * @return SPERM_ID
    */
    public Long getSpermId() {
        return getLong(D_SpermId);
    }
