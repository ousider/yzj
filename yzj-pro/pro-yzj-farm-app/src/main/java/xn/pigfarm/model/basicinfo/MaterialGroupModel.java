 ...
 * @Description:系统生成
 * @author :系统生成
 * @date :2016-8-18 9:50:10
 *       表：CD_M_MATERIAL_GROUP
 */
public class MaterialGroupModel  extends BaseDataModel implements Serializable{

    private static final long serialVersionUID = 5331192579042878088L;
    ...
    private static final String D_GroupName="groupName";
	 //supGroupId 
    private static final String D_SupGroupId="supGroupId";
	 //subjectId 
     ...
     * @param SUP_GROUP_ID
     */
	public void setSupGroupId(Long value) {
        set(D_SupGroupId,value);
    }
	...
	public List<String> getPropertes() {
	    if (super.getPropertes() == null || super.getPropertes().isEmpty()) {
	        ...
	        setPropertes(D_SupGroupId);
	        setPropertes(D_SubjectId);
	        setPropertes(D_MaterialType);
	    }
