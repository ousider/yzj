 ...
 *       表：CD_O_TEMPLATE
 */
public class TemplateModel  extends BaseDataModel implements Serializable{

    private static final long serialVersionUID = 4541816414909149782L;
    ...
    // wechatModuleId
    private static final String D_WechatModuleId = "wechatModuleId";
     ...
     * 设置wechatModuleId
     * 
     * @param WECHAT_MODULE_ID
     */
    public void setWechatModuleId(Long value) {
        set(D_WechatModuleId, value);
    }

    /**
     * 获取wechatModuleId
     * 
     * @return WECHAT_MODULE_ID
     */
    public Long getWechatModuleId() {
        return getLong(D_WechatModuleId);
    }
	...
	public List<String> getPropertes() {
	    if (super.getPropertes() == null || super.getPropertes().isEmpty()) {
	        ...
	        setPropertes(D_TemplateName);
	        setPropertes(D_TemplateStyle);
	        setPropertes(D_ModuleId);
	        setPropertes(D_RoleType);
            setPropertes(D_WechatModuleId);
	    }
