 ...
 * @Description:系统生成
 * @author :系统生成
 * @date :2016-8-18 9:50:05
 *       表：CD_O_DEVICE
 */
public class DeviceModel  extends BaseDataModel implements Serializable{

    private static final long serialVersionUID = 3622975829722240676L;
    ...
    // 工作电压
    private static final String D_Voltage="voltage";

    // 功率
    private static final String D_Power="power";

    // 折旧期限
    private static final String D_Anlb="anlb";
     ...
     * @param ANLB
     */
	public void setAnlb(Double value) {
        set(D_Anlb,value);
    }
     ...
     * @return ANLB
     */
    public Double getAnlb() {
        return getDouble(D_Anlb);
    }
	...
	public List<String> getPropertes() {
	    if (super.getPropertes() == null || super.getPropertes().isEmpty()) {
	        ...
	        setPropertes(D_Voltage);
	        setPropertes(D_Power);
	        setPropertes(D_Anlb);
