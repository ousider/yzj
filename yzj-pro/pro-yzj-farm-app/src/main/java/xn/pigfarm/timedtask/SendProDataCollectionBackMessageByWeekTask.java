...
public class SendProDataCollectionBackMessageByWeekTask implements Job {
    private static Logger log = Logger.getLogger(SendProDataCollectionBackMessageByWeekTask.class);

    public void execute(JobExecutionContext ctx) throws JobExecutionException {
        log.info("开始执行SendProDataCollectionBackMessageByWeekTask...........");
        ...
        try {
            ...
            if (reportId != 0) {
                this.SendProductionDataCollectionBackMessage(reportId, WechatConstants.MESSAGE_TYPE_PRODUCTION_COLLECTION_BACK);
            }
        }
        catch (Exception e) {
        ...
        log.info("结束执行SendProDataCollectionBackMessageByWeekTask...........");
    }

    public void SendProductionDataCollectionBackMessage(long reportId, String reportType) {
