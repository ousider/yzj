 ...
 */
public class OverPurchaseBillTask implements Job {

    private static Logger log = Logger.getLogger(OverPurchaseBillTask.class);

    public void execute(JobExecutionContext ctx) throws JobExecutionException {
        log.info("开始执行OverPurchaseBillTask...........");
        ...
        String endDateString = TimeUtil.format(calendar.getTime(), TimeUtil.DATE_FORMAT);
        ...
        purchaseBillSqlCon.addCondition(SupplyChianConstants.EVENT_CODE_MATERIAL_PURCHASE, " AND EVENT_CODE = ?");
        ...
        purchaseBillSqlCon.addCondition(endDateString, " AND BILL_DATE <= ?");
        ...
        for (PurchaseModel oldPurchaseModel : purchaseModelList) {
            ...
            for (int i = 0; i < purchaseDetailModelList.size(); i++) {
                ...
                purchaseDetailModel.setActualPrice(purchaseDetailModel.getActualPrice());
        ...
        log.info("结束执行OverPurchaseBillTask...........");
    }
