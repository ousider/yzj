...
public class SendProDataCollectionBackMessageByMonthTask implements Job {
    private static Logger log = Logger.getLogger(SendProDataCollectionBackMessageByMonthTask.class);

    public void execute(JobExecutionContext ctx) throws JobExecutionException {
        log.info("开始执行SendProDataCollectionBackMessageByMonthTask...........");
        ...
        try {
            ...
            if (reportId != 0) {
                this.SendProductionDataCollectionAnaMessage(reportId, WechatConstants.MESSAGE_TYPE_PRODUCTION_COLLECTION_BACK);
            }
        }
        catch (Exception e) {
        ...
        log.info("结束执行SendProDataCollectionBackMessageByMonthTask...........");
    }
