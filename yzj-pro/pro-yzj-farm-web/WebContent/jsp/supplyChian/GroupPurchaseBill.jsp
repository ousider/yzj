...
<head>
	...
	<script src="${base_url}/js/supplyChian/GroupPurchaseBill.js?v=${param.randomnumber}"></script>
</head>
<body>
	...
	<div id="editWin" class="easyui-window windowStyle" data-options="draggable:false,inline:true,left:'0px',top:'0px',collapsible:false,minimizable:false,maximizable:false,closable:false,closed:true,draggable:false,fit:true,footer:'#dlg-buttons'" style="overflow-x:hidden;">
		<form id="editForm" method="post" class="form-inline">
			<div style="display:none">
				...
				<input type="hidden" name="groupOrSelf" value="1"/>
			</div>
...
<!-- 						<div class="wd-com wd-3"><label class="label">采购员:</label></div> -->
<!-- 						<div class="wd-com wd-5"> -->
<!-- 							<input id="purchaserId" name="purchaserId" style="width:100%;height:32px"> -->
<!-- 						</div> -->
						...
						<div class="wd-com wd-1" id="checkboxDiv">&nbsp;&nbsp;<input type="checkbox" onchange="changeSupplierIdUrl(this)" /></div>
						<div class="wd-com wd-2"><label class="label">预计到货日期:</label></div>
						<div class="wd-com wd-5">
...
<!-- 			<button type="button" onclick="selectFeed()" id="selectFeed" class="listTableToolbarBtn">已入库饲料</button> -->
			...
			<div style="display:inline-block;vertical-align: middle;"><input type="checkbox" id="group" name="group" value="Y"/></div>
			<div style="display:inline-block;vertical-align: middle;">购买组合套餐</div>
		</div>
