...
<body style="min-width:1200px;min-height:600px;">
   			...
   			<div class="personalMessage">
   				...
   				<ul>
   					...
   					<li data-liname="字体大小">
   						...
   						<a href="#" onclick="fontSizeSet(this,'12px')">小</a>
						<a href="#" onclick="fontSizeSet(this,'14px')">中</a>
						<a href="#" onclick="fontSizeSet(this,'16px')">大</a>
					</li>
					<li data-liname="修改密码"><span class="changePassword"></span><a href="#" onclick="openPasswordWin()">修改密码</a></li>
					<li data-liname="切换账号"><span class="changeFarm"></span><a href="#" onclick="openFarmWin()">切换账号</a></li>
	...
	<div id="changeFarm" class="rightSlipWin_390">
		<div class="rightSlipTitle">
			<span class="arrow_right" onClick="closeFhangeFarmWin()"></span><span>切换账号</span>
		</div>
		<div class="rightSlipContent">
			<ul class="farmList">
<!-- 				<li><a href="#">大丰</a></li> -->
		 ...
		 <div class="rightSlipFooter">
			<button id="cancelPassword" type="button" onclick="closeFhangeFarmWin()" class="rightSlipBtn green">取消</button>
		</div>
	</div>
	<div id="topDateLog" class="easyui-window" title="更新提醒" style="width:600px;height:400px"
	        data-options="modal:true,collapsible:false,minimizable:false,maximizable:false,closed:true">
	        <div id="topDateLogDiv" class="win-con"></div>
	</div>
</body>
