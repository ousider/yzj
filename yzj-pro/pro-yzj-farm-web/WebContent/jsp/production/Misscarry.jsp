...
<head>
	...
	<script src="${base_url}/js/production/Misscarry.js?v=${param.randomnumber}"></script>
...
<div id="editWin" class="easyui-window windowStyle" data-options="title:'新增流产',draggable:false,inline:true,left:'0px',top:'0px',collapsible:false,minimizable:false,maximizable:false,closable:false,closed:false,draggable:false,fit:true,footer:'#dlg-buttons'" style="overflow-x:hidden;">
