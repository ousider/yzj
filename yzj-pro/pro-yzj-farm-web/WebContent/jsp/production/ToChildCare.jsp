...
<head>
	...
	<script src="${base_url}/js/production/ToChildCare.js?v=${param.randomnumber}"></script>
</head>
<body onKeyDown="keyBoardDown(event)" onKeyUp="keyBoardUp(event)">
	<div id="editWin" class="easyui-window windowStyle" data-options="title:'新增转保育',draggable:false,inline:true,left:'0px',top:'0px',collapsible:false,minimizable:false,maximizable:false,closable:false,closed:false,draggable:false,fit:true,footer:'#dlg-buttons'" style="overflow-x:hidden;">
		<form id="editForm" method="post">
			...
			<div id="toolbar">
				...
				<button type="button" onclick="selectToChildCarePig()" class="listTableToolbarBtn">选择猪只</button>
			</div>
			<div id="listTable"></div>
	</div>
	<div id="selectToChildCarePigWin" class="rightSlipWin_780 z-index_10000">
		<div class="rightSlipTitle">
			<span class="arrow_right" onClick="rightSlipFun('selectToChildCarePigWin',780,true)"></span><span>选择猪只</span>
		</div>
		...
		<form id="selectPigSearchForm" method="post">
			...
			<div id="searchToChildPigTable"></div>
		 </div>
		<div class="rightSlipFooter">
			...
			<button type="button" onclick="selectToChildCarePigSure()" class="rightSlipBtn blue">确定</button>
