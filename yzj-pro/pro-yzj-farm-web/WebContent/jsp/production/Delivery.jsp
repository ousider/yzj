...
<head>
	...
	<script src="${base_url}/js/production/Delivery.js?v=${param.randomnumber}"></script>
...
<body onKeyDown="keyBoardDown(event)" onKeyUp="keyBoardUp(event)">
	<div id="editWin" class="easyui-window windowStyle" data-options="title:'新增分娩',draggable:false,inline:true,left:'0px',top:'0px',collapsible:false,minimizable:false,maximizable:false,closable:false,closed:false,draggable:false,fit:true,footer:'#dlg-buttons'" style="overflow-x:hidden;">
		<form id="editForm" method="post">
				<div style="display:none">
					...
					<input type="hidden" name="FMSFLZ_flag" id="FMSFLZ_flag" value="OFF"/>
				</div>
	...
	<div id="dlg-buttons" style="height:65px;">
		<div style="height:20px;background-color:#DCEA60;padding:0 10px;text-align:right;">
				<span style="color:red;">合计：&nbsp;&nbsp;</span><span>健仔数：</span><span id="healthyNumSum">0</span>&nbsp;&nbsp;</span><span>弱仔数：</span><span id="weakNumSum">0</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<span>死胎：</span><span id="stillbirthNumSum">0</span>&nbsp;&nbsp;
				<span>木乃伊：</span><span id="mummyNumSum">0</span>&nbsp;&nbsp;
				<span>畸形：</span><span id="mutantNumSum">0</span>&nbsp;&nbsp;
				<span>窝均重：</span><span id="weightAvg">0</span>&nbsp;&nbsp;
				<span>窝均健仔：</span><span id="healthyNumAvg">0</span>&nbsp;&nbsp;
		</div>
