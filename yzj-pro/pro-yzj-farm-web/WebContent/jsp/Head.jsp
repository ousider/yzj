...
<script src="${base_url}/js/BaseFunction.js?v=${webVersion}"></script>
<script src="${base_url}/js/Widget.js?v=${webVersion}"></script>
<script src="${base_url}/js/ValidateEntend.js?v=${webVersion}"></script>
<script src="${base_url}/js/Grid.js?v=${webVersion}"></script>
<script src="${base_url}/js/GetRootPath.js?v=${webVersion}"></script>
<!-- <script src="${base_url}/js/xnJsCode.min.js?v=${webVersion}"></script> -->
<script src="${base_url}/lib/bigDecimal/BigDecimal-all-last.min.js?v=${webVersion}"></script>

<style type="text/css"> * {font-size:${FONT_SIZE} !important;} </style>
