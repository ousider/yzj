...
var saveUrl=prUrl + 'editLaboratoryUseMaterial.do';
var deleteUrl=prUrl + '';
/** *********页面渲染开始*************************************************************************/
$(document).ready(function(){
	...
	xnComboGrid({
		...
		url:'/supplyChian/searchWarehouseByMaterialTypeToList.do?roleFilterFlag=true&warehouseCategory=5',
		required:true,
		columns:[[ 	
	...
	xnComboGrid({
		...
		url:'/supplyChian/searchLaboratoryUseMaterialFarmToList.do',
		required:true,
		columns:[[ 	
					{field:'rowId',title:'ID',width:100,hidden:true},
